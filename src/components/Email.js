...
class Email extends Component {
  ...
  render() {
    return (
      <div id="mc_embed_signup" className="email__container bg-dark-gray p:8">
        <form action="https://jonbellah.us4.list-manage.com/subscribe/post?u=cd903cc3fde462d23ad126e77&amp;id=bbc672add9" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" className="validate" target="_blank" noValidate>
          <div className="container">
            <div className="w:12of12 t-a:c">
              <h2 className="email__title color-white f:5 f-w:700">Want to stay in the loop?</h2>
              <p className="email__desc color-white-75 d:i-b f:1 m-b:4">Get updates about new and upcoming conferences, open speaker calls, and early bird sales. Right in your inbox. No spam. Ever.</p>
            </div>
            <div className="mc-field-group d:f j-c:c a-i:f-s pos:r m-b:1">
              <span className="input__wrap pos:r m-r:.5">
